...
?>
	...
	<div class="social-icon-wrapper">
		...
		<div class="site-info">
			...
			<a href="<?php echo RUBBERSOUL_AUTHOR_URI; ?>/wordpress-themes/rubbersoul">RubberSoul</a> <?php _e('by', 'rubbersoul'); ?> GalussoThemes.com<br />
			<?php _e('Powered by', 'rubbersoul'); ?><a href="<?php echo esc_url( __( 'http://wordpress.org/', 'rubbersoul' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'rubbersoul' ); ?>"> WordPress</a>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
	...
	if (get_theme_mod('rubbersoul_boton_ir_arriba', 1) == 1){ ?>
		<a href='#inicio_pagina' title='<?php echo __('Back to top', 'rubbersoul'); ?>'><div class="ir-arriba"><i class="fa fa-chevron-up"></i></div></a>
	<?php }
