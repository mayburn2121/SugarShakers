...
add_action( 'customize_register', 'rubbersoul_customize_register' );

function rubbersoul_customize_register( $wp_customize ) {
...
$wp_customize->add_section('rubbersoul_color_favicon_sidebar' , array(
	...
	'title' => __('Logo, Color, Favicon and Sidebar','rubbersoul'),
	'priority'    => '40',
));
...
// Favicon
$wp_customize->add_setting( 'rubbersoul_favicon' , array('default' => '', 'sanitize_callback' => 'esc_url_raw',));
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'rubbersoul_favicon', array(
    'label'    => __( 'Favicon (ico, png or gif)', 'rubbersoul' ),
    'section'  => 'rubbersoul_color_favicon_sidebar',
    'settings' => 'rubbersoul_favicon',
) ) );
